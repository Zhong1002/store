...
class Weixinpay {
    ...
    private $config=array(
        ...
        'NOTIFY_URL'         => 'http://www.ddbookstore.com/index.php?g=WeChat&m=Weixinpay&a=notify', // 接收支付状态的连接  改成自己的域名
        );
    ...
    public function getParameters(){
        ...
        if (!isset($_GET['code'])) {
            ...
            $order=array(
                ...
                'total_fee'=>$order_price,// 订单金额  以(分)为单位（需要根据自己的业务修改）
